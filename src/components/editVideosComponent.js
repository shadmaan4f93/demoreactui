...
class EditVideosComponent extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      title: null,
  ...
  render() {
    return (
     <div>Edit Videos Coming Soon</div>     
...
export default connect(mapStateToProps, mapDispatchToProps)(EditVideosComponent);
